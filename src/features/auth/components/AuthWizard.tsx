...
// Lazy load LegalDocs
const LegalDocs = lazy(() => import('@/features/business/components/LegalDocs'));
 ...
 */
export default function AuthWizard({ user, onSuccess, isNewUser }: AuthWizardProps) {
  const { darkMode, toggleDarkMode: toggleTheme } = useUIStore();
