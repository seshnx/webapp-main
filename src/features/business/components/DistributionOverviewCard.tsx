...
/**
 * Props for DistributionOverviewCard component
 */
export interface DistributionOverviewCardProps {
    data?: DistributionOverviewData | null;
 ...
 * - Draft Releases
 */
export default function DistributionOverviewCard({ data, onNavigate }: DistributionOverviewCardProps) {
  return (
