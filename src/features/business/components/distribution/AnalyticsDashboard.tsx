...
export default function AnalyticsDashboard({ user }: AnalyticsDashboardProps): JSX.Element {
  ...
  const [topTerritories, setTopTerritories] = useState<Territory[]>([]);
  ...
  const getTerritoryTextColor = (index: number): string => {
    const colors = [
