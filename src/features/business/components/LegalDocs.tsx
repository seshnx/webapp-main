...
const PrivacyPolicy = () => (
    <>
        ...
        <DocSection title="3. Data Sharing">
            ...
            <DocList items={[
                "<strong>Service Providers:</strong> Clerk (Authentication), Convex (Data Infrastructure), Stripe (Payments).",
...
const CookiePolicy = () => (
    <>
        ...
        <DocSection title="Types of Cookies We Use">
            <DocList items={[
                "<strong>Essential Cookies:</strong> Required for login authentication (e.g., Clerk session tokens). The site cannot function without these.",
