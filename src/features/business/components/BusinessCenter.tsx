...
import { getOrgType } from '@/utils/orgTagParser';

// Import business components
import StudioManager from '@/features/studio/components/StudioManager';
import LabelDashboard from '@/features/business/components/labels/LabelDashboard';
import DistributionManager from '@/features/marketplace/components/DistributionManager';
import BusinessOverview from '@/features/business/components/business/BusinessOverview';
import TechManagement from '@/features/business/components/business/TechManagement';
...
export default function BusinessCenter({ user, userData }: BusinessCenterProps) {
    ...
    // Get org type from current active organization
    ...
    // Build available tabs based on org type
