...
import InspectionEditor from '@/features/business/components/tech/InspectionEditor';
import { InspectionSvg } from '@/features/business/components/tech/InspectionDiagrams';
...
function ListingDetailModal({ item, onClose, currentUser, currentUserData, onSafeExchangePurchase, onStandardPurchase }) {
    ...
    const { data: offers, loading: loadingOffers } = useGearOffers({ listingId: item.id });
    const { createOffer } = useMarketplaceMutations();
