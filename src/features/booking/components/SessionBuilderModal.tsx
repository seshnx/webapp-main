...
/**
 * Props for SessionBuilderModal component
 */
 ...
 */
interface LineItem extends CartItem {
    itemTotal: number;
    hourlyRate: number;
}
...
export default function SessionBuilderModal({
    user,
    userData,
    cart,
    onRemoveFromCart,
    ...
    const calculateTotals = (): CalculatedTotals => {
        let subtotal = 0;
        const safeDuration = parseInt(String(watchedDuration)) || 0;
    ...
    const inputClass = (error?: any) => twMerge(
