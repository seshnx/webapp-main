    ...
    const SidebarContent = () => (
        <div className="flex flex-col h-full">
            ...
            <div className="p-4 border-b dark:border-gray-700">
                ...
                {/* DEBUG / DEV ORG SWITCHER */}
                <div className="mt-4 px-1 p-2 bg-orange-50 dark:bg-orange-900/10 border border-orange-200 dark:border-orange-900/30 rounded-lg">
                    <div className="text-[10px] font-bold text-orange-500 mb-2 uppercase tracking-wider flex items-center justify-between">
                        <span>Debug: Clerk Org</span>
                    ...
                    <OrganizationSwitcher 
                        ...
                        appearance={{
                            elements: {
                                organizationSwitcherTrigger: "w-full justify-between bg-white dark:bg-[#1a1d21] border border-gray-200 dark:border-gray-700 rounded-md py-1.5 px-2",
