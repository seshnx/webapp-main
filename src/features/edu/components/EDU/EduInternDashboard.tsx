...
/**
 * EduInternDashboard props
 */
export interface EduInternDashboardProps {
    user?: any;
    userData?: any;
}
export default function EduInternDashboard({ user: propUser, userData: propUserData }: EduInternDashboardProps) {
    ...
    const milestones: Milestone[] = useMemo(() => {
        return studentProfile?.milestones || [];
    }, [studentProfile]);
