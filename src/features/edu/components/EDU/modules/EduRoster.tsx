...
export default function EduRoster({ schoolId: propSchoolId, logAction }: EduRosterProps) {
    const { schoolId: contextSchoolId } = useSchool();
    const schoolId = (propSchoolId || contextSchoolId) as Id<"schools"> | undefined;
    ...
    const partners = useQuery(
        api.partners.getPartnersBySchool,
    ...
    const loading = (!!schoolId && students === undefined) || (!!schoolId && partners === undefined);
