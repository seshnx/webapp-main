...
export default function EduCourses({ schoolId, logAction }: EduCoursesProps) {
    ...
    // Convex Mutations
    const removeClass = useMutation(api.edu.deleteClass);
    ...
    const courses: Course[] = useMemo(() => {
        ...
        return classes.map(c => ({
            ...
            lessonCount: 0, // TODO: Implement lesson counting in Convex
            enrollmentCount: 0, // TODO: Implement enrollment counting in Convex
    ...
    const handleDeleteCourse = async (courseId: string) => {
        ...
        try {
            await removeClass({ classId: courseId as Id<"classes"> });
