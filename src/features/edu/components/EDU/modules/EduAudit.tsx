...
export default function EduAudit({ schoolId }: EduAuditProps) {
    ...
    // Convex Query
    const logsData = useQuery(api.edu.getAuditLogsBySchool,
        schoolId ? { schoolId: schoolId as Id<"schools">, limit: logLimit } : "skip"
    );
    ...
    if (logsData === undefined && logs.length === 0) return <div className="p-10 text-center text-gray-500">Loading Audit Trail...</div>;
