                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setSettings({ ...settings, bidirectionalSync: e.target.checked })}
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setSettings({ ...settings, autoSync: e.target.checked })}
                                    className="sr-only peer"
                                />
                                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                            </label>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setSettings({ ...settings, syncConfirmedOnly: e.target.checked })}
                                    className="sr-only peer"
                                />
                                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                            </label>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setSettings({ ...settings, syncInterval: parseInt(e.target.value) || 15 })}
                ...
                <div className="bg-white dark:bg-[#2c2e36] rounded-xl border dark:border-gray-700 p-6">
                    ...
                    {syncResult.conflicts && syncResult.conflicts.length > 0 && (
                        <div className="mt-4">
                            ...
                            <div className="space-y-2">
                                {syncResult.conflicts.map((conflict: SyncConflict, index: number) => (
                                    <div
                                        key={index}
                    ...
                    {syncResult.errors && syncResult.errors.length > 0 && (
                        <div className="mt-4">
                            ...
                            <div className="space-y-2">
                                {syncResult.errors.map((error: SyncError, index: number) => (
                                    <div
                                        key={index}
