...
import type { Wall as FPWall, Structure as FPStructure, Layout as FPLayout } from '@/types/floorplan';
...
/**
 * Structure type alias for floorplan (doors, windows, furniture)
 */
type Structure = FPStructure;

/**
 * Wall type alias for floorplan
 */
type Wall = FPWall;
