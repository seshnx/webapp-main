...
/**
 * Props for Panorama360Viewer component
 */
 ...
 */
export default function Panorama360Viewer({ imageUrl, onClose, title = '360° View' }: Panorama360ViewerProps) {
    ...
    useEffect(() => {
        ...
        Promise.all([
            ...
            const pannellum = (pannellumModule as any).default || pannellumModule;

            // Initialize Pannellum viewer
            const viewer = (pannellum as any).viewer(containerRef.current, {
