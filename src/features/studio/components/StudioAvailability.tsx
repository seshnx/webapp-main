...
/**
 * StudioAvailability component props
 */
export interface StudioAvailabilityProps {
    user?: any;
    userData?: any;
    onUpdate?: (data: {
...
const DAYS_OF_WEEK: DayOfWeekConfig[] = [
...
export default function StudioAvailability({ user, userData, onUpdate }: StudioAvailabilityProps) {
    ...
    const updateDayHours = (dayId: string, field: keyof DayOperatingHours, value: string | boolean): void => {
        setHours(prev => ({
            ...prev,
    ...
    const toggleDayClosed = (dayId: string): void => {
        setHours(prev => ({
            ...prev,
    ...
    const copyToAllWeekdays = (dayId: string): void => {
    ...
    const totalWeeklyHours = DAYS_OF_WEEK.reduce((total: number, day: DayOfWeekConfig) => {
                                    ...
                                    <>
                                        <div className="flex items-center gap-2">
                                            <input
                                                ...
                                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateDayHours(day.id, 'open', e.target.value)}
                                            ...
                                            <input
                                                ...
                                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateDayHours(day.id, 'close', e.target.value)}
                                                className="p-2 border rounded-lg dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                                            />
                                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewBlackout({ ...newBlackout, start: e.target.value })}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewBlackout({ ...newBlackout, end: e.target.value })}
                                    className="w-full p-2 border rounded-lg dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewBlackout({ ...newBlackout, reason: e.target.value })}
                ...
                <div className="p-4">
                    {blackoutDates.length === 0 ? (
                        ...
                        <div className="space-y-2">
                            {blackoutDates.sort((a, b) => new Date(a.start).getTime() - new Date(b.start).getTime()).map((blackout: BlackoutDate) => (
                                <div
                                    key={blackout.id}
