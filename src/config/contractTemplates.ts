...
5. ADVANCE
Label shall pay to Artist an advance of $ {{advance_amount_val}} ("Advance") upon execution of this Agreement. The Advance shall be recoupable from all royalties due to Artist.
...
Label agrees to spend a minimum of $ {{marketing_commitment_val}} on marketing and promotion for each release.
...
4. ADVANCE
Label shall pay Artist an advance of $ {{advance_amount_val}}, recoupable from royalties.
...
{{artist_legal_name}}`,
    ...
    fields: {
      ...
      advance_amount_val: { label: 'Advance Amount ($)', type: 'number', required: true, default: 0 },
 ...
 */
export const fillTemplate = (templateText: string, values: Record<string, any>): string => {
