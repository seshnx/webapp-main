...
import { REPORT_REASONS, submitReport } from '../utils/moderation';
...
interface ReportTarget {
    id: string;
    type: 'post' | 'comment' | 'user' | 'message' | 'market_item';
    summary: string;
}

/**
 * User object for reporting
 */
 ...
 *
 * Allows users to submit moderation reports against content or other users.
 *
 * @example
 * <ReportModal
 *   user={{ uid: '123', displayName: 'John Doe' }}
 *   target={{ id: '456', type: 'post', summary: 'Spam content' }}
 *   onClose={() => setShowModal(false)}
 * />
 */
export default function ReportModal({ user, target, onClose }: ReportModalProps) {
