 ...
 * Modal step type
 */
type ModalStep = 'confirm' | 'select';

/**
 * Profile selection modal props
 */
export interface ProfileSelectionModalProps {
  /** Whether to show the modal */
  show: boolean;
  /** Callback with selected role */
  onConfirm: (role: string) => void;
  /** Callback when user cancels */
  onCancel: () => void;
  /** User data with account types and active role */
  userData: UserData | null;
  /** User's sub-profiles keyed by account type */
  subProfiles?: Record<string, any>;
  /** Modal title */
  title?: string;
  /** Additional message to show */
  message?: string;
  /** Roles to exclude from selection */
  excludeRoles?: string[];
}
 ...
 *
 * @param props - Profile selection modal props
 * @returns Modal component
 *
 * @example
 * <ProfileSelectionModal
 *   show={showModal}
 *   onConfirm={(role) => console.log('Selected:', role)}
 *   onCancel={() => setShowModal(false)}
 *   userData={userData}
 *   subProfiles={subProfiles}
 *   title="Create Post"
 *   message="Which profile should create this post?"
 * />
 */
...
}: ProfileSelectionModalProps): React.ReactElement | null {
