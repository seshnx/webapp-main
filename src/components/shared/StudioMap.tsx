 ...
 *
 * Displays studio locations on an interactive Leaflet map.
 *
 * @param props - Studio map props
...
export default function StudioMap({
  ...
  drawRadius = false,
  radiusMiles = 0
}: StudioMapProps): React.ReactElement {
