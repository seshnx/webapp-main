...
import { useEquipmentSearch, type EquipmentSearchResult } from '../../hooks/useEquipmentSearch';

/**
 * Equipment autocomplete component props
 */
export interface EquipmentAutocompleteProps {
  /** Selection callback */
  onSelect?: (item: EquipmentSearchResult & { fullName: string }) => void;
  /** Input placeholder */
  placeholder?: string;
...
/**
 * Equipment Autocomplete Component
 *
 * Provides equipment search with autocomplete suggestions.
 *
 * @param props - Equipment autocomplete props
...
export default function EquipmentAutocomplete({
  ...
  onChange,
  multi = false
}: EquipmentAutocompleteProps): React.ReactElement {
  ...
  const handleSelect = (item: EquipmentSearchResult) => {
