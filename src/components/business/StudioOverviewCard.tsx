...
/**
 * Studio overview data interface
 */
...
/**
 * Props for StudioOverviewCard component
 */
export interface StudioOverviewCardProps {
    data?: StudioOverviewData | null;
 ...
 * - Completed Bookings
 */
export default function StudioOverviewCard({ data, onNavigate }: StudioOverviewCardProps) {
  return (
