...
/**
 * Props for TechDirectory component
 */
export interface TechDirectoryProps {
    user?: any;
...
/**
 * TechDirectory - Searchable directory of technicians
 * TODO: Migrate to Neon database - currently disabled
 */
export default function TechDirectory({ user, userData, openPublicProfile }: TechDirectoryProps) {
    ...
    const runSearch = async () => {
        // TODO: Implement Neon query for technicians table
        console.warn('TechDirectory: Neon database integration not yet implemented');
        ...
        <div className="animate-in fade-in">
                        ...
                        <div key={tech.id} className="bg-white dark:bg-[#2c2e36] rounded-xl border dark:border-gray-700 overflow-hidden shadow-sm hover:shadow-lg transition group">
                            ...
                            <div className="pt-10 px-6 pb-6">
                                <div className="flex justify-between items-start">
                                    ...
                                    {tech.rate && tech.rate > 0 && <div className="text-sm font-bold dark:text-gray-300 border border-gray-200 dark:border-gray-600 px-2 py-1 rounded-lg">${tech.rate}/hr</div>}
                                </div>
            ...
            {!loading && techs.length === 0 && (
                <div className="text-center py-12 text-gray-400">
                    ...
                    <p className="text-xs mt-2">Directory will be available once Neon migration is complete.</p>
                </div>
            )}
