...
import { Radio, Users, Plus, Mic, Sparkles, Volume2 } from 'lucide-react';
...
export default function LiveSpacesBar({ user, userSettings }: LiveSpacesBarProps) {
  ...
  return (
    <div className="mb-6 bg-gradient-to-r from-purple-950/30 via-gray-900/40 to-blue-950/30 backdrop-blur-md rounded-2xl p-4 sm:p-5 border border-purple-800/25 shadow-lg shadow-purple-950/10">
      {/* Header Bar */}
      <div className="flex items-center justify-between mb-3.5">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3.5 py-1.5 bg-gradient-to-r from-purple-600 to-brand-blue text-white rounded-xl text-xs font-bold hover:opacity-90 transition shadow-md shadow-purple-600/20"
        >
