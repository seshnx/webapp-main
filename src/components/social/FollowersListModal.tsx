...
import { getFollowers, getFollowing } from '../../config/mongoSocial';
...
/**
 * Props for FollowersListModal component
 */
export interface FollowersListModalProps {
    userId: string;
    userName?: string;
    initialTab?: 'followers' | 'following' | string;
    currentUser?: any;
    currentUserData?: any;
...
export default function FollowersListModal({
    ...
    const handleToggleFollow = async (targetUser: ListUser) => {
