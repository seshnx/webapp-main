...
import type { BreadcrumbItem as BreadcrumbItemType } from '../../config/breadcrumbConfig';
...
/**
 * Breadcrumb Root Component Props
 */
 ...
 */
export interface BreadcrumbNavProps extends BreadcrumbProps {
  showHome?: boolean;
  homeLabel?: string;
  homePath?: string;
...
const BreadcrumbNav = React.forwardRef<HTMLElement, BreadcrumbNavProps>(
  ({ className, showHome = false, homeLabel = 'dashboard', homePath = '/dashboard', separator, ...props }, ref) => {
    ...
    const displayBreadcrumbs: BreadcrumbItemType[] = showHome
    ...
    return (
      <Breadcrumb ref={ref as any} className={className} {...props}>
        <BreadcrumbList>
 ...
 */
const BreadcrumbNavCompact = React.forwardRef<HTMLElement, BreadcrumbProps>(
  ({ className, ...props }, ref) => {
 ...
 */
const BreadcrumbNavWithHome = React.forwardRef<HTMLElement, BreadcrumbNavProps & { homePath?: string }>(
  ({ className, homePath = '/dashboard', ...props }, ref) => {
    const { breadcrumbs, isRoot } = useBreadcrumbs();
