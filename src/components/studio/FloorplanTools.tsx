...
import {
    ...
    Grid, Lock, Unlock, AlignLeft, AlignCenter, AlignRight, LucideIcon
} from 'lucide-react';

/**
 * Floorplan tool type
 */
export type FloorplanToolId =
    | 'select' | 'wall' | 'room' | 'structure'
...
/**
 * Props for FloorplanTools component
 */
export interface FloorplanToolsProps {
    activeTool: FloorplanToolId;
    setActiveTool: (tool: FloorplanToolId) => void;
    onUndo: () => void;
    onRedo: () => void;
    canUndo: boolean;
    canRedo: boolean;
