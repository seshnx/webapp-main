...
/**
 * Room time slots mapping
 */
interface RoomTimeSlots {
...
/**
 * MultiRoomBookingModal component props
 */
export interface MultiRoomBookingModalProps {
    booking: Booking;
    rooms: Room[];
    onClose: () => void;
    onSuccess?: () => void;
 ...
 */
export default function MultiRoomBookingModal({ booking, rooms, onClose, onSuccess }: MultiRoomBookingModalProps) {
    ...
    useEffect(() => {
        ...
        if (booking?.booking_start && booking?.duration) {
            ...
            const initialSlots: RoomTimeSlots = {};
    ...
    const handleRoomToggle = (roomId: string): void => {
    ...
    const handleTimeChange = (roomId: string, field: keyof TimeSlot, value: string): void => {
                                        ...
                                        <div className="mt-3 pt-3 border-t dark:border-gray-600 grid grid-cols-2 gap-2">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleTimeChange(room.id, 'start', e.target.value)}
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleTimeChange(room.id, 'end', e.target.value)}
                                                    className="w-full p-1.5 text-sm border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                                                />
                                            </div>
                                        </div>
