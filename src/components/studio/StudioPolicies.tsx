...
/**
 * StudioPolicies component props
 */
...
export default function StudioPolicies({ user, userData, onUpdate }: StudioPoliciesProps) {
    ...
    const updatePolicy = <K extends keyof StudioPolicies>(key: K, value: StudioPolicies[K]): void => {
        setPolicies(prev => ({ ...prev, [key]: value }));
    };

    const CANCELLATION_POLICIES: CancellationPolicyOption[] = [
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('minBookingHours', parseInt(e.target.value) || 1)}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('maxBookingHours', parseInt(e.target.value) || 12)}
                                className="w-full p-3 border rounded-xl dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                                min={1}
                            />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('advanceBookingDays', parseInt(e.target.value) || 7)}
                                className="w-full p-3 border rounded-xl dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                                min={1}
                            />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('minAdvanceHours', parseInt(e.target.value) || 0)}
                                className="w-full p-3 border rounded-xl dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                                min={0}
                            />
                        </div>
                    ...
                    <div className="bg-gray-50 dark:bg-[#1f2128] p-4 rounded-xl flex items-center justify-between">
                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('autoApprove', e.target.checked)}
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('cancellationNoticeHours', parseInt(e.target.value) || 24)}
                                    className="w-full p-3 border rounded-xl dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                                    min={0}
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('refundPercentage', parseInt(e.target.value) || 0)}
                                    className="w-full p-3 border rounded-xl dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                                    min={0}
                                    max={100}
                                />
                        ...
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('depositRequired', e.target.checked)}
                                    className="sr-only peer"
                                />
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('depositPercentage', parseInt(e.target.value))}
                                        className="flex-1"
                                        min={10}
                                        max={100}
                                        step={5}
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('peakHoursStart', e.target.value)}
                                    className="w-full p-3 border rounded-xl dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('peakHoursEnd', e.target.value)}
                                    className="w-full p-3 border rounded-xl dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('peakHourMultiplier', parseFloat(e.target.value) || 1)}
                                    className="w-full p-3 border rounded-xl dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                                    min={1}
                                    max={3}
                                    step={0.1}
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-4">
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('weekendMultiplier', parseFloat(e.target.value))}
                                className="flex-1"
                                min={1}
                                max={2}
                                step={0.1}
                ...
                <div className="space-y-4 pt-4">
                    <div>
                        ...
                        <textarea
                            ...
                            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updatePolicy('houseRules', e.target.value)}
                            className="w-full p-3 border rounded-xl dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                            rows={4}
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updatePolicy('whatToExpect', e.target.value)}
                            className="w-full p-3 border rounded-xl dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                            rows={3}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updatePolicy('whatToBring', e.target.value)}
                                className="w-full p-3 border rounded-xl dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                                rows={3}
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updatePolicy('parkingInstructions', e.target.value)}
                                className="w-full p-3 border rounded-xl dark:bg-[#1f2128] dark:border-gray-600 dark:text-white"
                                rows={3}
                    ...
                    <div className="flex items-center gap-4">
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('ageRequirement', parseInt(e.target.value) || 0)}
                        ...
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => updatePolicy('requiresWaiver', e.target.checked)}
                                    className="sr-only peer"
                                />
                                <div className="w-11 h-6 bg-gray-200 peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-brand-blue"></div>
                            </label>
                        ...
                        {policies.requiresWaiver && (
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updatePolicy('waiverText', e.target.value)}
