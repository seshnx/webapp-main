...
import { Shield, FileText, Lock, Globe, Cookie, ChevronRight } from 'lucide-react';

export default function LegalDocs({ isEmbedded = false }) {
    ...
    return (
        <div className={`flex flex-col md:flex-row bg-white dark:bg-[#1f2128] h-full ${!isEmbedded ? 'max-w-6xl mx-auto rounded-2xl shadow-xl border dark:border-gray-700 overflow-hidden my-8 min-h-[600px]' : ''}`}>
