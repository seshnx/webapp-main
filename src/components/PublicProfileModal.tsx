...
/**
 * Profile data interface from Neon
 */
...
/**
 * Props for PublicProfileModal component
 */
...
/**
 * PublicProfileModal Component
 *
 * Displays a user's public profile with the ability to:
 * - View profile information, stats, and equipment
 * - Follow/unfollow the user
 * - Send a message
 * - Upload banner (if owner)
 *
 * @example
 * <PublicProfileModal
 *   userId="123"
 ...
 *   onMessage={(userId, userName) => startChat(userId, userName)}
 * />
 */
                    ...
                    {loading ? <LoadingSkeleton /> : error || !profile ? (
                        ...
                        <>
                            ...
                            <div className="px-8 pb-8 relative">
                                <div className="flex justify-between items-end -mt-14 mb-6">
                                    ...
                                    {currentUser && !isOwner && (
                                        <div className="flex gap-2 mb-2">
                                            ...
                                            />
                                            <button
                                                onClick={() => onMessage(userId, `${profile.firstName || ''} ${profile.lastName || ''}`.trim())}
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-6 border-y dark:border-gray-800 mb-8">
                                    <div className="text-center md:text-left">
                                        ...
                                        <div className="flex items-center justify-center md:justify-start gap-1">
                                            ...
                                            {profile.rating && profile.rating > 0 && <StarRating rating={profile.rating} size={14} />}
                                        </div>
                                    </div>
                                    <div className="text-center md:text-left">
                                ...
                                {/* SKILLS & GENRES */}
                                {(profile.genres && profile.genres.length > 0 || profile.instruments && profile.instruments.length > 0) && (
                                    <div className="mb-8">
                                        <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3 flex items-center gap-2">
