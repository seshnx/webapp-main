...
/**
 * Props for SessionWizard component
 */
export interface SessionWizardProps {
    userData?: any;
    sessionParams?: SessionParams | null;
    setSessionParams: (params: SessionParams | null) => void;
    onNext: () => void;
}
                ...
                <form onSubmit={handleLogisticsSubmit} className="p-8 space-y-6 max-w-2xl mx-auto">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                onChange={e => setSessionParams({ ...(sessionParams || safeSessionParams), date: e.target.value })}
                            />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                onChange={e => setSessionParams({ ...(sessionParams || safeSessionParams), time: e.target.value })}
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <LocationPicker
                            ...
                            onLocationChange={(loc) => setSessionParams({ ...(sessionParams || safeSessionParams), location: loc })}
                        />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={e => setSessionParams({ ...(sessionParams || safeSessionParams), radius: parseInt(e.target.value) })}
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                {['Low', 'Normal', 'High'].map(u => (
                                    <button
                                        key={u} type="button"
                                        onClick={() => setSessionParams({ ...(sessionParams || safeSessionParams), urgency: u })}
