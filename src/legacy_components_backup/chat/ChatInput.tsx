...
/**
 * Message data interface for reply/edit
 */
...
export interface ChatInputProps {
    ...
    replyingTo?: MessageRef | null;
    editingMessage?: MessageRef | null;
    onCancelReply?: () => void;
    onCancelEdit?: () => void;
    typingUsers?: any[];
    onTyping?: () => void;
...
/**
 * Chat input component with attachments, voice recording, GIF, emoji support
 */
export default function ChatInput({
    ...
    const handleGifSelect = async (gifData: any) => {
        try {
    ...
    const handleVideoRecorded = async (videoFile: File) => {
        try {
    ...
    const startRecording = async () => {
        try {
            ...
            recorder.ondataavailable = (e: BlobEvent) => audioChunks.current.push(e.data);
            recorder.onstop = () => {
            ...
            <form onSubmit={handleSubmit} className="flex items-end gap-2">
                ...
                <div className="flex-1 bg-gray-100 dark:bg-[#1f2128] rounded-2xl border dark:border-gray-700 focus-within:ring-2 focus-within:ring-brand-blue transition-all flex items-end relative">
                    <textarea
                        ...
                        placeholder={
                            editingMessage ? (t('editingMessage') + '...') as string :
                                dragActive ? (t('dropFiles') + '...') as string :
                                    (t('typeMessage') || 'Type a message...') as string
                        }
                        value={input}
