...
interface MessageReactions {
    [emoji: string]: string[] | Record<string, boolean>;
}
...
export interface MessageBubbleProps {
    ...
    onSeshNxLinkClick?: (data: LinkPreviewData) => void;
...
export default function MessageBubble({
    ...
    const isSameDay = previousMessage &&
        new Date(message.t || 0).toDateString() === new Date(previousMessage.t || 0).toDateString();
    ...
    const reactionCounts = message.reactions
        ? Object.entries(message.reactions).reduce((acc: Record<string, number>, [emoji, users]) => {
