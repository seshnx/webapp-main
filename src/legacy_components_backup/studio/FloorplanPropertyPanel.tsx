...
/**
 * FloorplanPropertyPanel props
 */
export interface FloorplanPropertyPanelProps {
...
export default function FloorplanPropertyPanel({
    ...
    const handleUpdate = (updates: Partial<SelectedItem>) => {
                ...
                <div className="space-y-3">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ layout: { ...layout, x: Number(e.target.value) } })}
                                className="w-full p-2 border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                                placeholder="X"
                            />
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ layout: { ...layout, y: Number(e.target.value) } })}
                                className="w-full p-2 border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                                placeholder="Y"
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <div>
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ layout: { ...layout, width: Number(e.target.value) } })}
                                    className="w-full p-2 border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                                    placeholder="Width"
                                />
                            ...
                            <div>
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ layout: { ...layout, height: Number(e.target.value) } })}
                                    className="w-full p-2 border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                                    placeholder="Height"
                                />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ layout: { ...layout, color: e.target.value } })}
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ rotation: Number(e.target.value) })}
                ...
                <div className="space-y-3">
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ label: e.target.value })}
                            className="w-full p-2 border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                        />
                    </div>
                    <div>
                ...
                <div className="space-y-3">
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ x1: Number(e.target.value) })}
                                className="w-full p-2 border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                            />
                            <input
                                type="number"
                                value={Math.round(selectedItem.y1 || 0)}
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ y1: Number(e.target.value) })}
                                className="w-full p-2 border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                            />
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ x2: Number(e.target.value) })}
                                className="w-full p-2 border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                            />
                            <input
                                type="number"
                                value={Math.round(selectedItem.y2 || 0)}
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ y2: Number(e.target.value) })}
                                className="w-full p-2 border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ strokeWidth: Number(e.target.value) })}
                            className="w-full p-2 border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                            min="1"
                            max="20"
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ stroke: e.target.value })}
                            className="w-full h-10 border rounded cursor-pointer"
                        />
                    </div>
                </div>
                ...
                <div className="space-y-3">
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ subType: e.target.value })}
                            className="w-full p-2 border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <input
                                ...
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ x: Number(e.target.value) })}
                                className="w-full p-2 border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                            />
                            <input
                                type="number"
                                value={Math.round(selectedItem.y || 0)}
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleUpdate({ y: Number(e.target.value) })}
                                className="w-full p-2 border rounded dark:bg-[#1f2128] dark:border-gray-600 dark:text-white text-sm"
                            />
                        </div>
                    </div>
