...
/**
 * Props for StudioDetailsCard component
 */
export interface StudioDetailsCardProps {
    studioData: StudioDetailsData;
}

export default function StudioDetailsCard({ studioData }: StudioDetailsCardProps) {
            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                        {(studioData.amenities || []).map((a: string) => (
