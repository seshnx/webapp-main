...
export default function StudioGallery({ user, userData, onUpdate }: StudioGalleryProps) {
    ...
    const handleDelete = async (photoIndex: number): Promise<void> => {
    ...
    const handleSetCover = async (photoIndex: number): Promise<void> => {
