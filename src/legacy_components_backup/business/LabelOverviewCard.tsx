 ...
 */
export interface LabelOverviewData {
...
/**
 * Props for LabelOverviewCard component
 */
export interface LabelOverviewCardProps {
    data?: LabelOverviewData | null;
 ...
 * - Total Streams
 */
export default function LabelOverviewCard({ data, onNavigate }: LabelOverviewCardProps) {
