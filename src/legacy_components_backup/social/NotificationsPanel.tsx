...
interface Notification {
    ...
    message: string;
    timestamp?: Date | string | { toMillis: () => number };
    postId?: string;
    postPreview?: string;
    bookingId?: string;
    bookingDetails?: {
...
const NotificationItem = ({
    ...
    const handleBookingAction = async (e: React.MouseEvent, action: 'accept' | 'decline') => {
        e.stopPropagation();
        if (!notification.bookingId || !onBookingAction) return;
