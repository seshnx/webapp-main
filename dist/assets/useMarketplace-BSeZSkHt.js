import{ap as o,r as u}from"./vendor-B4TWoEsZ.js";import{n as _}from"./edu-Dgdq2qcb.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};e.SENTRY_RELEASE={id:"local"};var r=new e.Error().stack;r&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[r]="57385e95-bc33-4779-8961-a15073bf686a",e._sentryDebugIdIdentifier="sentry-dbid-57385e95-bc33-4779-8961-a15073bf686a")}catch{}})();async function c(e,r=[],t="Unnamed Query"){if(!_)throw new Error("Neon client is not configured");try{return await _(e,r)}catch(s){throw console.error(`Database error in ${t}:`,s),new Error(`Query ${t} failed: ${s instanceof Error?s.message:String(s)}`)}}async function y(e={}){const{limit:r=50,status:t,category:s,sellerId:a}=e;let i=`SELECT gl.*,
